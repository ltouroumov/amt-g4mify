...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/badges/badgesModule.js',
			'app/modules/badges/badgesCtrl.js',
			'app/modules/badges/badgesRoute.js',
			'app/modules/badges/badgesService.js',
			'app/modules/badges/badges-test.js',
		],
