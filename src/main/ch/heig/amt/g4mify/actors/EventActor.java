...
public class EventActor extends UntypedActor {
    ...
    @Autowired
    public EventActor(EventsRepository eventsRepository,
    ...
    private void processEvent(ReceivedEvent message) throws InterruptedException {
        ...
        for (BadgeRule rule : badgeRules) {
            ...
            evaluateBadgeRule(user, rule, expr);
        }
    ...
    private void evaluateBadgeRule(User user, BadgeRule rule, Expression expr) {
